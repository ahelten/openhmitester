...
/// processes control
///
void PreloadController::capture_start() { _ev_consumer->startCapture(); }

void PreloadController::capture_pause() { _ev_consumer->pauseCapture(); }

void PreloadController::capture_stop() { _ev_consumer->stopCapture(); }

void PreloadController::execution_start() { _ev_executor->startExecution(); }

void PreloadController::execution_pause() { _ev_executor->pauseExecution(); }

void PreloadController::execution_stop() { _ev_executor->stopExecution(); }
